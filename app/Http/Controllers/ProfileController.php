                ...
                if ($request->file('avatar')->isValid()) {
                    ...
                    if (!is_writable($uploadPath)) {
                        ...
                        if (!chmod($uploadPath, 0775)) {
                            \Log::error('Cannot set write permissions on upload directory: ' . $uploadPath);
                            throw new \Exception('Cannot set write permissions on upload directory');
                        }
                    }
                    ...
                    try {
                        ...
                        throw new \Exception('Error adding media: ' . $e->getMessage());
                    }
                } else {
