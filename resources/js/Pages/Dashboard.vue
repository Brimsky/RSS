                                ...
                                <div class="space-y-4 flex-grow">
                                    ...
                                    <template v-if="$page.props.auth.user.role === 'seller' || $page.props.auth.user.role === 'admin'">
                                        <a href="products/create">
                                            <button
                                                class="w-full flex items-center justify-center space-x-2 bg-blue-500 text-white px-6 py-3 rounded-lg text-lg hover:bg-blue-600 transition duration-300"
                                            >
                                        ...
                                        <button
                                            class="w-full flex items-center justify-center space-x-2 bg-gray-200 text-gray-700 px-6 py-3 rounded-lg text-lg hover:bg-gray-300 transition duration-300"
                                        >
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                class="h-6 w-6"
                        ...
                        >
                            <div class="space-y-6 mb-16">
                                ...
                                >
                                    ...
                                    >
                                        <button
                                            class="bg-blue-100 text-blue-600 px-4 py-2 rounded-full text-lg hover:bg-blue-200 transition duration-300"
                                        >
                                            Mark as sold
                                        </button>
                                    </template>
                            ...
                            <a
                                href="/products"
                                class="absolute bottom-6 right-6 bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 transition duration-300"
                            >
                                View all
                            </a>
                        </div>
