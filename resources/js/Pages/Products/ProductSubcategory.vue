  ...
  <div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="text-center mb-12">
        <h1 class="text-3xl md:text-4xl font-bold bg-gradient-to-r from-purple-600 to-blue-500 bg-clip-text text-transparent inline-block">
          {{ category }}
        </h1>
        <div class="mt-2 flex items-center justify-center text-gray-600">
          ...
          <span class="ml-2 text-xl">{{ subcategory ? subcategory : 'Subcategories' }}</span>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <Link
          ...
          :key="subcategory"
          :href="route('products.listings', { category, subcategory })"
        ...
        >
          ...
          <div class="p-6 flex items-center">
            <!-- Icon -->
            <div class="w-12 h-12 rounded-xl bg-gradient-to-br from-purple-100 to-blue-100 
                        group-hover:from-purple-200 group-hover:to-blue-200 
            ...
            <!-- Title -->
            <h2 class="ml-4 text-lg font-semibold text-gray-900 group-hover:text-purple-600 transition-colors duration-300">
              {{ subcategory }}
            </h2>
          ...
          <!-- Bottom Gradient Bar -->
          <div class="h-1 bg-gradient-to-r from-purple-500 to-blue-500 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300">
          </div>
        </Link>
      </div>
    </div>
